module LdapAuth
  class InstallGenerator < Rails::Generators::Base
    ...
    class_option :update_model, :type => :boolean, :default => true, :desc => "Update model to change from database_authenticatable to ldap_auth"
    class_option :add_rescue, :type => :boolean, :default => true, :desc => "Update Application Controller with resuce_from for LdapAuth::LdapException"
    ...
    def update_user_model
      gsub_file "app/models/#{options.user_model}.rb", /:database_authenticatable/, ":ldap_auth" if options.update_model?
    end
